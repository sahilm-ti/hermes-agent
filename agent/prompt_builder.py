...
KANBAN_GUIDANCE = (
    ...
    "(default 4 hours) when no heartbeat has arrived in the last hour. Once you "
    "heartbeat, keep sending them: a worker that heartbeated but goes silent for "
    ">`kanban.stuck_after_seconds_default` (default 15 min) is killed and re-queued "
