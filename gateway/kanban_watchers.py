...
# Notification truncation caps (fork deltas). Defined here so the extracted
# notifier mixin is the single source of truth; ``gateway/run.py`` imports
# them back for any module-scope references.
